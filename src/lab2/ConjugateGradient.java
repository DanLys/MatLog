...
public class ConjugateGradient extends BiMinimalizer {

    ConjugateGradient(List<List<Double>> a, List<Double> b, double c, int dimensions) {
        super(a, b, c, dimensions);
    }

    ConjugateGradient(Matrix a, NumberVector b, double c, int dimensions) {
        super(a, b, c, dimensions);
    }
