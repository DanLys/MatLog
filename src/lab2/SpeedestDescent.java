...
public class SpeedestDescent extends BiMinimalizer {
    SpeedestDescent(List<List<Double>> A, List<Double> B, Double C, int dimensions) {
        super(A, B, C, dimensions);
    }

    SpeedestDescent(Matrix a, NumberVector b, double c, int dimensions) {
        super(a, b, c, dimensions);
    }
    ...
    private List<Double> steepestDescent() {
        ...
        while (!stop) {
            ...
            minimalizer = new MethodDichotomy(function, 0, 1);
            lambda = minimalizer.getMinimalValue(0.0000001);
